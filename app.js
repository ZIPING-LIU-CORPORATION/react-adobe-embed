...
/**
   ...
   */function l(e){return void 0===e&&(e={}),function(e,t,n,r){void 0===r&&(r={});let{window:l=document.defaultView,v5Compat:c=!1}=r,m=l.history,p=a.Pop,f=null,v=g();
// Index should only be null when we initialize. If not, it's because the
// user called history.pushState or history.replaceState directly, in which
// case we should log a warning as it will result in bugs.
null==v&&(v=0,m.replaceState(o({},m.state,{idx:v}),""));function g(){return(m.state||{idx:null}).idx}function b(){p=a.Pop;let e=g(),t=null==e?null:e-v;v=e,f&&f({action:p,location:R.location,delta:t})}function y(e,t){p=a.Push;let r=d(R.location,e,t);n&&n(r,e),v=g()+1;let o=u(r,v),i=R.createHref(r);
// try...catch because iOS limits us to 100 pushState calls :/
try{m.pushState(o,"",i)}catch(e){
...
l.location.assign(i)}c&&f&&f({action:p,location:R.location,delta:1})}function w(e,t){p=a.Replace;let r=d(R.location,e,t);n&&n(r,e),v=g();let o=u(r,v),i=R.createHref(r);m.replaceState(o,"",i),c&&f&&f({action:p,location:R.location,delta:0})}function E(e){
...
let t=E(e);return{pathname:t.pathname,search:t.search,hash:t.hash}},push:y,replace:w,go:e=>m.go(e)};return R}
//#endregion
...
/**
   ...
   */function d(e,t,n,a){return void 0===n&&(n=null),o({pathname:"string"==typeof e?e:e.pathname,search:"",hash:""},"string"==typeof t?m(t):t,{state:n,
...
/**
   ...
   */function m(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let a=e.indexOf("?");a>=0&&(t.search=e.substr(a),e=e.substr(0,a)),e&&(t.pathname=e)}return t}var p;
/**
   * Matches the given routes to a location and returns the match data.
   *
   * @see https://reactrouter.com/utils/match-routes
   */
function f(e,t,n){void 0===n&&(n="/");let a=k(("string"==typeof t?m(t):t).pathname||"/",n);if(null==a)return null;let r=v(e);!function(e){e.sort(((e,t)=>e.score!==t.score?t.score-e.score:function(e,t){let n=e.length===t.length&&e.slice(0,-1).every(((e,n)=>e===t[n]));return n?
...
/**
   * @private
   */function I(e,t,n,a){let r;void 0===a&&(a=!1),"string"==typeof e?r=m(e):(r=o({},e),s(!r.pathname||!r.pathname.includes("?"),P("?","pathname","search",r)),s(!r.pathname||!r.pathname.includes("#"),P("#","pathname","hash",r)),s(!r.search||!r.search.includes("#"),P("#","search","hash",r)));let i,l=""===e||""===r.pathname,c=l?"/":r.pathname;
...
// the root / URL.
i=e>=0?t[e]:"/"}let u=function(e,t){void 0===t&&(t="/");let{pathname:n,search:a="",hash:r=""}="string"==typeof e?m(e):e,o=n?n.startsWith("/")?n:function(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach((e=>{".."===e?
...
/**
   ...
   * @license MIT
   */
function j(){return j=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},j.apply(this,arguments)}
// Create react-specific types from the agnostic types in @remix-run/router to
// export from react-router
new Set(M);const F=r.createContext(null);F.displayName="DataRouter";const W=r.createContext(null);W.displayName="DataRouterState";r.createContext(null).displayName="Await";
/**
   ...
   */
const H=r.createContext(null);H.displayName="Navigation";const V=r.createContext(null);V.displayName="Location";const $=r.createContext({outlet:null,matches:[],isDataRoute:!1});$.displayName="Route";const z=r.createContext(null);
/**
   * Returns true if this component is a descendant of a `<Router>`.
   *
   * @see https://reactrouter.com/hooks/use-in-router-context
   */
function K(){return null!=r.useContext(V)}
/**
   ...
   */function G(){return K()||s(!1,// TODO: This error is probably because they somehow have 2 versions of the
// router loaded. We can help them understand how to avoid that.
"useLocation() may be used only in the context of a <Router> component."),r.useContext(V).location}
/**
   * The interface for the navigate() function returned from useNavigate().
   */z.displayName="RouteError";const J="You should call navigate() in a React.useEffect(), not when your component is first rendered.";
// Mute warnings for calls to useNavigate in SSR environments
function Z(e){r.useContext(H).static||
...
/**
   ...
   */function X(){let{isDataRoute:e}=r.useContext($);
...
/**
   ...
   * a RouterProvider.
   */
function(){let{router:e}=function(e){let t=r.useContext(F);return t||s(!1,oe(e)),t}(ae.UseNavigateStable),t=ie(re.UseNavigateStable),n=r.useRef(!1);return Z((()=>{n.current=!0})),r.useCallback((function(a,r){void 0===r&&(r={}),c(n.current,J),
// Short circuit here since if this happens on first render the navigate
// is useless because we haven't wired up our router subscriber yet
n.current&&("number"==typeof a?e.navigate(a):e.navigate(a,j({fromRouteId:t},r)))}),[e,t])}():function(){K()||s(!1,// TODO: This error is probably because they somehow have 2 versions of the
// router loaded. We can help them understand how to avoid that.
"useNavigate() may be used only in the context of a <Router> component.");let e=r.useContext(F),{basename:t,navigator:n}=r.useContext(H),{matches:a}=r.useContext($),{pathname:o}=G(),i=JSON.stringify(A(a).map((e=>e.pathnameBase))),l=r.useRef(!1);return Z((()=>{l.current=!0})),r.useCallback((function(a,r){
// Short circuit here since if this happens on first render the navigate
// is useless because we haven't wired up our history listener yet
if(void 0===r&&(r={}),c(l.current,J),!l.current)return;if("number"==typeof a)return void n.go(a);let s=I(a,JSON.parse(i),o,"path"===r.relative);
...
/**
   ...
   */()}function Y(e,t){let{relative:n}=void 0===t?{}:t,{matches:a}=r.useContext($),{pathname:o}=G(),i=JSON.stringify(A(a).map((e=>e.pathnameBase)));return r.useMemo((()=>I(e,JSON.parse(i),o,"path"===n)),[e,i,o,n])}
/**
...
// router loaded. We can help them understand how to avoid that.
"useRoutes() may be used only in the context of a <Router> component.");let{navigator:o}=r.useContext(H),{matches:i}=r.useContext($),l=i[i.length-1],u=l?l.params:{},d=l?l.pathname:"/",h=l?l.pathnameBase:"/",p=l&&l.route;{
...
//   );
// }
let e=p&&p.path||"";v=d,g=!p||e.endsWith("*"),b='You rendered descendant <Routes> (or called `useRoutes()`) at "'+d+'" (under <Route path="'+e+'">) but the parent route path has no trailing "*". This means if you navigate deeper, the parent won\'t match anymore and therefore the child routes will never render.\n\nPlease change the parent <Route path="'+e+'"> to <Route path="'+("/"===e?"*":e+"/*")+'">.',g||le[v]||(le[v]=!0,c(!1,b))}var v,g,b;
/**
   * Declares an element that should be rendered at a certain URL path.
   *
   * @see https://reactrouter.com/components/route
   */let y,w=G();if(t){var E;let e="string"==typeof t?m(t):t;"/"===h||(null==(E=e.pathname)?void 0:E.startsWith(h))||s(!1,'When overriding the location using `<Routes location>` or `useRoutes(routes, location)`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "'+h+'" but pathname "'+e.pathname+'" was given in the `location` prop.'),y=e}else y=w;let R=y.pathname||"/",C="/"===h?R:R.slice(h.length)||"/",x=f(e,{pathname:C});c(p||null!=x,'No routes matched location "'+y.pathname+y.search+y.hash+'" '),c(null==x||void 0!==x[x.length-1].route.element||void 0!==x[x.length-1].route.Component,'Matched leaf route at location "'+y.pathname+y.search+y.hash+'" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.');let N=function(e,t,n){var a,o;void 0===t&&(t=[]);void 0===n&&(n=null);if(null==e){if(null==(o=n)||!o.errors)return null;
...
return n&&(a.route.ErrorBoundary||a.route.errorElement||0===o)?r.createElement(te,{location:n.location,revalidation:n.revalidation,component:c,error:s,children:d(),routeContext:{outlet:null,matches:u,isDataRoute:!0}}):d()}),null)}(x&&x.map((e=>Object.assign({},e,{params:Object.assign({},u,e.params),pathname:T([h,
...
if(t&&N)
return r.createElement(V.Provider,{value:{location:j({pathname:"/",search:"",hash:"",state:null,key:"default"},y),navigationType:a.Pop}},N);return N}(e,t)}function Q(){let e=
/**
...
}componentDidCatch(e,t){console.error("React Router caught the following error during render",e,t)}render(){return this.state.error?r.createElement($.Provider,{value:this.props.routeContext},r.createElement(z.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function ne(e){let{routeContext:t,match:n,children:a}=e,o=r.useContext(F);
...
let d=t.replace(/^\/*/,"/"),h=r.useMemo((()=>({basename:d,navigator:l,static:u})),[d,l,u]);"string"==typeof o&&(o=m(o));let{pathname:p="/",search:f="",hash:v="",state:g=null,key:b="default"}=o,y=r.useMemo((()=>{let e=k(p,d);return null==e?null:{location:{pathname:e,search:f,hash:v,state:g,key:b},navigationType:i}}),[d,p,f,v,g,b,i]);return c(null!=y,'<Router basename="'+d+'"> is not able to match the URL "'+p+f+v+"\" because it does not start with the basename, so the <Router> won't render anything."),null==y?null:r.createElement(H.Provider,{value:h},r.createElement(V.Provider,{children:n,value:y}))}
/**
   * A container for a nested tree of `<Route>` elements that renders the branch
   * that best matches the current location.
   *
   * @see https://reactrouter.com/components/routes
   */function ue(e){let{children:t,location:n}=e;return q(de(t),n)}
///////////////////////////////////////////////////////////////////////////////
// UTILS
///////////////////////////////////////////////////////////////////////////////
/**
...
/**
   ...
   *
   * @license MIT
   */function he(){return he=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var a in n)Object.prototype.hasOwnProperty.call(n,a)&&(e[a]=n[a])}return e},he.apply(this,arguments)}function me(e,t){if(null==e)return{};var n,a,r={},o=Object.keys(e);for(a=0;a<o.length;a++)n=o[a],t.indexOf(n)>=0||(r[n]=e[n]);return r}new Promise((()=>{}));const pe="get",fe="application/x-www-form-urlencoded";function ve(e){return null!=e&&"string"==typeof e.tagName}
...
let i=e.getAttribute("action");a=i?k(i,t):null,n=e.getAttribute("method")||pe,r=ye(e.getAttribute("enctype"))||fe,o=new FormData(e)}else if(function(e){return ve(e)&&"button"===e.tagName.toLowerCase()}(e)||function(e){return ve(e)&&"input"===e.tagName.toLowerCase()}(e)&&("submit"===e.type||"image"===e.type)){let i=e.form;if(null==i)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
...
if(a=l?k(l,t):null,n=e.getAttribute("formmethod")||i.getAttribute("method")||pe,r=ye(e.getAttribute("formenctype"))||ye(i.getAttribute("enctype"))||fe,
...
n=pe,a=null,r=fe,i=e}var l;return o&&"text/plain"===r&&(i=o,o=void 0),{action:a,method:n.toLowerCase(),encType:r,formData:o,body:i}}const Ee=["onClick","relative","reloadDocument","replace","state","target","to","preventScrollReset","unstable_viewTransition"],Re=["aria-current","caseSensitive","className","end","style","to","unstable_viewTransition","children"],Ce=["reloadDocument","replace","state","method","action","onSubmit","submit","relative","preventScrollReset","unstable_viewTransition"],xe=r.createContext({isTransitioning:!1});xe.displayName="ViewTransition";
//#endregion
////////////////////////////////////////////////////////////////////////////////
//#region Components
////////////////////////////////////////////////////////////////////////////////
...
// router loaded. We can help them understand how to avoid that.
"useHref() may be used only in the context of a <Router> component.");let{basename:a,navigator:o}=r.useContext(H),{hash:i,pathname:l,search:c}=Y(e,{relative:n}),u=l;
// If we're operating within a basename, prepend it to the pathname prior
// to creating the href.  If this is a root navigation, then just use the raw
// basename which allows the basename to have full control over the presence
// of a trailing slash on root links
return"/"!==a&&(u="/"===l?a:T([a,l])),o.createHref({pathname:u,search:c,hash:i})}(m,{relative:o}),w=
/**
   * Handles the click behavior for router `<Link>` components. This is useful if
   * you need to create custom `<Link>` components with the same click behavior we
   * use in our exported `<Link>`.
   */
function(e,t){let{target:n,replace:a,state:o,preventScrollReset:i,relative:l,unstable_viewTransition:s}=void 0===t?{}:t,c=X(),u=G(),d=Y(e,{relative:l});return r.useCallback((t=>{if(function(e,t){return!(0!==e.button||
...
let n=void 0!==a?a:h(u)===h(d);c(e,{replace:n,state:o,preventScrollReset:i,relative:l,unstable_viewTransition:s})}}),[u,c,d,a,o,n,e,i,l,s])}(m,{replace:l,state:u,target:d,preventScrollReset:p,relative:o,unstable_viewTransition:f});

// eslint-disable-next-line jsx-a11y/anchor-has-content
return r.createElement("a",he({},v,{href:n||y,onClick:b||i?a:function(e){a&&a(e),e.defaultPrevented||w(e)},ref:t,target:d}))}));ke.displayName="Link";r.forwardRef((function(e,t){let{"aria-current":n="page",caseSensitive:a=!1,className:o="",end:i=!1,style:l,to:c,unstable_viewTransition:u,children:d}=e,h=me(e,Re),m=Y(c,{relative:h.relative}),p=G(),f=r.useContext(W),{navigator:v}=r.useContext(H),g=null!=f&&
// Conditional usage is OK here because the usage of a data router is static
// eslint-disable-next-line react-hooks/rules-of-hooks
/**
...
return null!=D(o.pathname,l)||null!=D(o.pathname,i)}(m)&&!0===u,b=v.encodeLocation?v.encodeLocation(m).pathname:m.pathname,y=p.pathname,w=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;a||(y=y.toLowerCase(),w=w?w.toLowerCase():null,b=b.toLowerCase());let E,R=y===b||!i&&y.startsWith(b)&&"/"===y.charAt(b.length),C=null!=w&&(w===b||!i&&w.startsWith(b)&&"/"===w.charAt(b.length)),x={isActive:R,isPending:C,isTransitioning:g},N=R?n:void 0;E="function"==typeof o?o(x):[o,R?"active":null,C?"pending":null,g?"transitioning":null].filter(Boolean).join(" ");let S="function"==typeof l?l(x):l;
return r.createElement(ke,he({},h,{"aria-current":N,className:E,ref:t,style:S,to:c,unstable_viewTransition:u}),"function"==typeof d?d(x):d)})).displayName="NavLink";r.forwardRef(((e,t)=>{let n=
/**
   * Returns a function that may be used to programmatically submit a form (or
   * some arbitrary data) to the server.
   */
function(){let{router:e}=Te(Ae.UseSubmit),{basename:t}=r.useContext(H),n=ie(re.UseRouteId);return r.useCallback((function(a,r){void 0===r&&(r={}),function(){if("undefined"==typeof document)throw new Error("You are calling submit during the server render. Try calling submit within a `useEffect` or callback instead.")}();let{action:o,method:i,encType:l,formData:s,body:c}=we(a,t);e.navigate(r.action||o,{preventScrollReset:r.preventScrollReset,formData:s,body:c,formMethod:r.method||i,formEncType:r.encType||l,replace:r.replace,state:r.state,fromRouteId:n,unstable_viewTransition:r.unstable_viewTransition})}),[e,t,n])}
// v7: Eventually we should deprecate this entirely in favor of using the
// router method directly?
();
return r.createElement(Pe,he({},e,{submit:n,ref:t}))})).displayName="Form";const Pe=r.forwardRef(((e,t)=>{let{reloadDocument:n,replace:a,state:o,method:i=pe,action:l,onSubmit:c,submit:u,relative:d,preventScrollReset:m,unstable_viewTransition:p}=e,f=me(e,Ce),v="get"===i.toLowerCase()?"get":"post",g=function(e,t){let{relative:n}=void 0===t?{}:t,{basename:a}=r.useContext(H),o=r.useContext($);o||s(!1,"useFormAction must be used inside a RouteContext");let[i]=o.matches.slice(-1),l=he({},Y(e||".",{relative:n})),c=G();
...
/**
   ...
   */function Me(t){const[n,a]=e.useState(!1),[r,o]=e.useState(!1),[i,l]=e.useState(!1),s=(0,e[t?.useReactHookForAdobeAPIConfigs||"useMemo"])((()=>{if(!0===n){const e=window.AdobeDC?.View;return e}}),[n]);(0,e[t?.useReactHookWhenLoadingAdobeAPI||"useEffect"])((()=>{if(!1===i){const e=document.querySelector(".react-adobe-embed-handholding-adobe-api-loading-idiocy");if(e)t.debug&&console.info("[1mAdobe SDK Check[0m","Reloading and Rerendering Adobe SDK"),
// Lightbox mode renders from ui event triggered by user, so no need to render
"LIGHT_BOX"!==t.previewConfig?.embedMode&&o(!0),e.setAttribute("data-testid","react-adobe-embed-handholding-adobe-api-loading-idiocy-reused");else{t.debug&&console.info("[1mAdobe SDK Check[0m","Initial Adobe SDK Load");const e=document.createElement("script");e.setAttribute("data-testid","react-adobe-embed-handholding-adobe-api-loading-idiocy-initial"),e.setAttribute("data-adobe-pdf-id",t.id||je.staticDivId),e.setAttribute("class","react-adobe-embed-handholding-adobe-api-loading-idiocy"),e.src=t.previewConfig?.viewSdkViewerScript||je.staticDefaultConfig.viewSdkViewerScript,e.async=!0,e.onload=()=>{l(!0)},document.body.appendChild(e)}}}),[t.id,i,n]);(0,e[t?.useReactHookWhenCallingAdobeAPI||"useEffect"])((()=>{!1===n&&!0===i&&document.addEventListener("adobe_dc_view_sdk.ready",(()=>{a(!0)}));!0===i&&!0===n&&(e=>{e.debug&&console.info("Adobe PDF Viewer SDK Ready Event",s,window.adobe_dc_view_sdk);const t=e.id||je.staticDivId;document.getElementById(t)&&"LIGHT_BOX"!==e.previewConfig?.embedMode?(e.debug&&console.info("Adobe PDF Viewer SDK Ready Rendering"),Be({divId:t,viewerConfig:e.previewConfig||je.staticDefaultConfig,url:e.url||je.demoUrl,clientID:e.clientId,_fileMeta:e.fileMeta})):"LIGHT_BOX"===e.previewConfig?.embedMode&&e?.triggerAdobeDCViewRender&&Be({divId:e.id||je.staticDivId,viewerConfig:e.previewConfig||je.staticDefaultConfig,url:e.url||je.demoUrl,clientID:e.clientId})})(t)}),[n,i,t,s]);return(0,e[t?.useReactHookForComponentDidUpdate||"useEffect"])((()=>{if(!0===r){const e=t.id||je.staticDivId;document.getElementById(e)&&Be({divId:e,viewerConfig:t.previewConfig||je.staticDefaultConfig,url:t.url||je.demoUrl,clientID:t.clientId,_fileMeta:t.fileMeta}),o(!1)}}),[r,t]),e.createElement(_e,{...t})}const je={demoUrl:"https://acrobatservices.adobe.com/view-sdk-demo/PDFs/Bodea%20Brochure.pdf",staticDefaultConfig:{showAnnotationTools:!1,showLeftHandPanel:!1,showPageControls:!1,viewSdkViewerScript:"https://acrobatservices.adobe.com/view-sdk/viewer.js",showDownloadPDF:!1,showPrintPDF:!1},staticDivId:"pdf-div",demoMetaData:{fileName:"Odd Distateful Adobe Example Pdf.pdf",id:"6d07d124 - ac85–43b3 - a867–36930f502ac6"}};function Fe(){switch(window.location.hostname){case"localhost":default:return"324caa2a91b84f688935436cd2d25217";case"ziping.dev":return"2aeb65914ea244cd85c16b60ca3b688d";case"ziping.life":return"2daf6038d0f1447fb9dd17988e93b5b8";case"ziping.org":return"312487a25a5b4c0d845f6d93e8103c32";case"awsuni.com":return"50d3f2b88101430f8da3006527dcdf78";case"twitterliu.com":return"ac52e99ebc8242e9bf85ecb55444f726";case"one.ziping.org":return"2e5605e61e5b4306829b619d6fad2dc4";case"zipingl.github.io":return"9c16d364507948289a9f65f9ab9da8bf";case"ziping-liu-corporation.github.io":return"875691e089ad4bf6bc4c5cea79403542"}}function We(){const t=window.location.href.split("?")[1],n=new URLSearchParams(t),a=n.get("pdf")||n.get("url")||"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",r=n.get("width"),o=n.get("height"),i=n.get("fileName")||a.split("/").pop()||"23andMe_Ancestry_Book.pdf";return e.createElement("section",{id:"about",className:"container section"},e.createElement("div",{className:"row ws-m"},e.createElement("header",{className:"sec-heading"},e.createElement("h2",null,"Basic Test View"),e.createElement("span",{className:"subheading"},"Using the react-adobe-embed component with no additional configurations, except for the pdf url, in order to test the rendering of a PDF at the most basic level of usage.")),e.createElement(Me,{previewConfig:{},className:"col container-fluid post-content",fileMeta:{fileName:i},style:{width:r||"100%",height:o||"calc(100vh - 200px)",maxHeight:"100%",border:"1px solid transparent",alignContent:"center",justifyContent:"center",minHeight:"500px"},url:a||"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",debug:!0,id:"adobe-dc-view-0",clientId:Fe()})))}function He(){return e.createElement("section",{className:"container section"},e.createElement("div",{className:"row ws-m"},e.createElement("div",{className:"col s12",style:{height:"calc(100vh - 420px)"}},e.createElement(Me,{url:"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",clientId:Fe(),previewConfig:{embedMode:"LIGHT_BOX"},debug:!0}),e.createElement("button",{className:"btn btn-primary",onClick:()=>{Be({url:"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",viewerConfig:{embedMode:"LIGHT_BOX"},clientID:Fe(),divId:"pdf-div",_fileMeta:{fileName:"23andMe_Ancestry_Book.pdf"}})}},"Toggle Light Box View"))))}const Ve=document.getElementById("app");Ve&&t.createRoot(Ve).render(e.createElement((function(){return e.createElement(Se,null,e.createElement(Ue,null),e.createElement(ue,null,e.createElement(se,{path:"/test",element:e.createElement("div",{className:"section container"},e.createElement("div",{className:"row"},e.createElement("div",{className:"col s12"},e.createElement("h5",{"data-testid":"test-route",className:"header"},"Test Route View"),e.createElement("iframe",{src:"https://one.ziping.org/ZIPING-LIU-CORPORATION/react-adobe-embed/blob/slave/README.md/?domain=github.com",style:{width:"100%",height:"900px",border:"1px solid transparent",alignContent:"center",justifyContent:"center"}}))))}),e.createElement(se,{path:"/home",element:e.createElement(We,null)}),e.createElement(se,{path:"/light",element:e.createElement(He,null)})),e.createElement(Oe,null))}),null))}));
