...
/**
   ...
   */
function f(e,t,n){void 0===n&&(n="/");let a=P(("string"==typeof t?p(t):t).pathname||"/",n);if(null==a)return null;let r=v(e);!function(e){e.sort(((e,t)=>e.score!==t.score?t.score-e.score:function(e,t){let n=e.length===t.length&&e.slice(0,-1).every(((e,n)=>e===t[n]));return n?
...
/**
   ...
   */
function K(){return null!=r.useContext($)}
/**
   ...
   */function J(){return K()||s(!1,// TODO: This error is probably because they somehow have 2 versions of the
...
function Y(e){r.useContext(V).static||
...
/**
   ...
   */function q(){let{isDataRoute:e}=r.useContext(H);
...
/**
   ...
   * a RouterProvider.
   */
function(){let{router:e}=function(e){let t=r.useContext(F);return t||s(!1,oe(e)),t}(ae.UseNavigateStable),t=ie(re.UseNavigateStable),n=r.useRef(!1);return Y((()=>{n.current=!0})),r.useCallback((function(a,r){void 0===r&&(r={}),c(n.current,G),
// Short circuit here since if this happens on first render the navigate
// is useless because we haven't wired up our router subscriber yet
n.current&&("number"==typeof a?e.navigate(a):e.navigate(a,M({fromRouteId:t},r)))}),[e,t])}():function(){K()||s(!1,// TODO: This error is probably because they somehow have 2 versions of the
// router loaded. We can help them understand how to avoid that.
"useNavigate() may be used only in the context of a <Router> component.");let e=r.useContext(F),{basename:t,navigator:n}=r.useContext(V),{matches:a}=r.useContext(H),{pathname:o}=J(),i=JSON.stringify(A(a).map((e=>e.pathnameBase))),l=r.useRef(!1);return Y((()=>{l.current=!0})),r.useCallback((function(a,r){
// Short circuit here since if this happens on first render the navigate
...
/**
   ...
   */()}function Z(e,t){let{relative:n}=void 0===t?{}:t,{matches:a}=r.useContext(H),{pathname:o}=J(),i=JSON.stringify(A(a).map((e=>e.pathnameBase)));return r.useMemo((()=>T(e,JSON.parse(i),o,"path"===n)),[e,i,o,n])}
/**
...
let i=e.getAttribute("action");a=i?P(i,t):null,n=e.getAttribute("method")||me,r=ye(e.getAttribute("enctype"))||fe,o=new FormData(e)}else if(function(e){return ve(e)&&"button"===e.tagName.toLowerCase()}(e)||function(e){return ve(e)&&"input"===e.tagName.toLowerCase()}(e)&&("submit"===e.type||"image"===e.type)){let i=e.form;if(null==i)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
...
if(a=l?P(l,t):null,n=e.getAttribute("formmethod")||i.getAttribute("method")||me,r=ye(e.getAttribute("formenctype"))||ye(i.getAttribute("enctype"))||fe,
...
n=p,De))try{let e=new URL(window.location.href),t=p.startsWith("//")?new URL(e.protocol+p):new URL(p),n=P(t.pathname,g);t.origin===e.origin&&null!=n?
...
/**
   ...
   */
function(e,t){let{target:n,replace:a,state:o,preventScrollReset:i,relative:l,unstable_viewTransition:s}=void 0===t?{}:t,c=q(),u=J(),d=Z(e,{relative:l});return r.useCallback((t=>{if(function(e,t){return!(0!==e.button||
...
return r.createElement("a",he({},v,{href:n||y,onClick:b||i?a:function(e){a&&a(e),e.defaultPrevented||w(e)},ref:t,target:d}))}));Pe.displayName="Link";r.forwardRef((function(e,t){let{"aria-current":n="page",caseSensitive:a=!1,className:o="",end:i=!1,style:l,to:c,unstable_viewTransition:u,children:d}=e,h=pe(e,Re),p=Z(c,{relative:h.relative}),m=J(),f=r.useContext(W),{navigator:v}=r.useContext(V),g=null!=f&&
// Conditional usage is OK here because the usage of a data router is static
// eslint-disable-next-line react-hooks/rules-of-hooks
/**
...
return r.createElement(Pe,he({},h,{"aria-current":S,className:E,ref:t,style:N,to:c,unstable_viewTransition:u}),"function"==typeof d?d(x):d)})).displayName="NavLink";r.forwardRef(((e,t)=>{let n=
/**
