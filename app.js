...
if("*"===a){let e=l[n]||"";i=o.slice(0,o.length-e.length).replace(/(.)\/+$/,"$1")}const s=l[n];return e[a]=r&&!s?void 0:(s||"").replace(/%2F/g,"/"),e}),{}),pathname:o,pathnameBase:i,pattern:e}}function k(e){try{return e.split("/").map((e=>decodeURIComponent(e).replace(/\//g,"%2F"))).join("/")}catch(t){return c(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent encoding ('+t+")."),e}}
/**
   * @private
   */function L(e,t){if("/"===t)return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;
...
function T(e,t){let n=function(e){return e.filter(((e,t)=>0===t||e.route.path&&e.route.path.length>0))}(e);
...
/**
   * @private
   */function A(e,t,n,a){let r;void 0===a&&(a=!1),"string"==typeof e?r=p(e):(r=o({},e),s(!r.pathname||!r.pathname.includes("?"),P("?","pathname","search",r)),s(!r.pathname||!r.pathname.includes("#"),P("#","pathname","hash",r)),s(!r.search||!r.search.includes("#"),P("#","search","hash",r)));let i,l=""===e||""===r.pathname,c=l?"/":r.pathname;
...
// router loaded. We can help them understand how to avoid that.
"useNavigate() may be used only in the context of a <Router> component.");let e=r.useContext(j),{basename:t,future:n,navigator:a}=r.useContext(H),{matches:o}=r.useContext($),{pathname:i}=q(),l=JSON.stringify(T(o,n.v7_relativeSplatPath)),u=r.useRef(!1);return Z((()=>{u.current=!0})),r.useCallback((function(n,r){
// Short circuit here since if this happens on first render the navigate
// is useless because we haven't wired up our history listener yet
if(void 0===r&&(r={}),c(u.current,G),!u.current)return;if("number"==typeof n)return void a.go(n);let o=A(n,JSON.parse(l),i,"path"===r.relative);
...
/**
   ...
   */()}function X(e,t){let{relative:n}=void 0===t?{}:t,{future:a}=r.useContext(H),{matches:o}=r.useContext($),{pathname:i}=q(),l=JSON.stringify(T(o,a.v7_relativeSplatPath));return r.useMemo((()=>A(e,JSON.parse(l),i,"path"===n)),[e,l,i,n])}
/**
...
// router loaded. We can help them understand how to avoid that.
"useRoutes() may be used only in the context of a <Router> component.");let{navigator:i}=r.useContext(H),{matches:l}=r.useContext($),u=l[l.length-1],d=u?u.params:{},h=u?u.pathname:"/",m=u?u.pathnameBase:"/",v=u&&u.route;{
...
if(t&&C)
return r.createElement(V.Provider,{value:{location:F({pathname:"/",search:"",hash:"",state:null,key:"default"},g),navigationType:a.Pop}},C);return C}(e,t)}function Q(){let e=
/**
...
let h=t.replace(/^\/*/,"/"),m=r.useMemo((()=>({basename:h,navigator:l,static:u,future:F({v7_relativeSplatPath:!1},d)})),[h,d,l,u]);"string"==typeof o&&(o=p(o));let{pathname:f="/",search:v="",hash:g="",state:b=null,key:y="default"}=o,w=r.useMemo((()=>{let e=L(f,h);return null==e?null:{location:{pathname:e,search:v,hash:g,state:b,key:y},navigationType:i}}),[h,f,v,g,b,y,i]);return c(null!=w,'<Router basename="'+h+'"> is not able to match the URL "'+f+v+g+"\" because it does not start with the basename, so the <Router> won't render anything."),null==w?null:r.createElement(H.Provider,{value:m},r.createElement(V.Provider,{children:n,value:w}))}
/**
   * A container for a nested tree of `<Route>` elements that renders the branch
   * that best matches the current location.
   *
   * @see https://reactrouter.com/components/routes
   */function de(e){let{children:t,location:n}=e;return Y(he(t),n)}
///////////////////////////////////////////////////////////////////////////////
// UTILS
///////////////////////////////////////////////////////////////////////////////
/**
...
if(a=l?L(l,t):null,n=e.getAttribute("formmethod")||i.getAttribute("method")||fe,r=we(e.getAttribute("formenctype"))||we(i.getAttribute("enctype"))||ve,
...
// no-op
}const xe=r.createContext({isTransitioning:!1});xe.displayName="ViewTransition";r.createContext(new Map).displayName="Fetchers";
//#endregion
////////////////////////////////////////////////////////////////////////////////
//#region Components
////////////////////////////////////////////////////////////////////////////////
...
return r.createElement("a",pe({},v,{href:n||y,onClick:b||i?a:function(e){a&&a(e),e.defaultPrevented||w(e)},ref:t,target:d}))}));Pe.displayName="Link";r.forwardRef((function(e,t){let{"aria-current":n="page",caseSensitive:a=!1,className:o="",end:i=!1,style:l,to:c,unstable_viewTransition:u,children:d}=e,h=me(e,Ce),p=X(c,{relative:h.relative}),m=q(),f=r.useContext(W),{navigator:v,basename:g}=r.useContext(H),b=null!=f&&
// Conditional usage is OK here because the usage of a data router is static
// eslint-disable-next-line react-hooks/rules-of-hooks
/**
...
return null!=D(o.pathname,l)||null!=D(o.pathname,i)}(p)&&!0===u,y=v.encodeLocation?v.encodeLocation(p).pathname:p.pathname,w=m.pathname,E=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;a||(w=w.toLowerCase(),E=E?E.toLowerCase():null,y=y.toLowerCase()),E&&g&&(E=L(E,g)||E);
// If the `to` has a trailing slash, look at that exact spot.  Otherwise,
// we're looking for a slash _after_ what's in `to`.  For example:
// <NavLink to="/users"> and <NavLink to="/users/">
// both want to look for a / at index 6 to match URL `/users/matt`
const R="/"!==y&&y.endsWith("/")?y.length-1:y.length;let C,N=w===y||!i&&w.startsWith(y)&&"/"===w.charAt(R),x=null!=E&&(E===y||!i&&E.startsWith(y)&&"/"===E.charAt(y.length)),S={isActive:N,isPending:x,isTransitioning:b},k=N?n:void 0;C="function"==typeof o?o(S):[o,N?"active":null,x?"pending":null,b?"transitioning":null].filter(Boolean).join(" ");let P="function"==typeof l?l(S):l;
return r.createElement(Pe,pe({},h,{"aria-current":k,className:C,ref:t,style:P,to:c,unstable_viewTransition:u}),"function"==typeof d?d(S):d)})).displayName="NavLink";
//#endregion
////////////////////////////////////////////////////////////////////////////////
//#region Hooks
////////////////////////////////////////////////////////////////////////////////
var Te,Ae;function _e(e){let t=r.useContext(j);return t||s(!1,
// Internal hooks
function(e){return e+" must be used within a data router.  See https://reactrouter.com/routers/picking-a-router."}(e)),t}r.forwardRef(((e,t)=>{let{fetcherKey:n,navigate:a,reloadDocument:o,replace:i,state:l,method:c=fe,action:u,onSubmit:d,relative:p,preventScrollReset:m,unstable_viewTransition:f}=e,v=me(e,Ne),g=
/**
   * Returns a function that may be used to programmatically submit a form (or
   * some arbitrary data) to the server.
   */
function(){let{router:e}=_e(Te.UseSubmit),{basename:t}=r.useContext(H),n=ie(re.UseRouteId);return r.useCallback((function(a,r){void 0===r&&(r={}),function(){if("undefined"==typeof document)throw new Error("You are calling submit during the server render. Try calling submit within a `useEffect` or callback instead.")}();let{action:o,method:i,encType:l,formData:s,body:c}=Ee(a,t);if(!1===r.navigate){let t=r.fetcherKey||Oe();e.fetch(t,n,r.action||o,{preventScrollReset:r.preventScrollReset,formData:s,body:c,formMethod:r.method||i,formEncType:r.encType||l,unstable_flushSync:r.unstable_flushSync})}else e.navigate(r.action||o,{preventScrollReset:r.preventScrollReset,formData:s,body:c,formMethod:r.method||i,formEncType:r.encType||l,replace:r.replace,state:r.state,fromRouteId:n,unstable_flushSync:r.unstable_flushSync,unstable_viewTransition:r.unstable_viewTransition})}),[e,t,n])}
// v7: Eventually we should deprecate this entirely in favor of using the
// router method directly?
(),b=function(e,t){let{relative:n}=void 0===t?{}:t,{basename:a}=r.useContext(H),o=r.useContext($);o||s(!1,"useFormAction must be used inside a RouteContext");let[i]=o.matches.slice(-1),l=pe({},X(e||".",{relative:n})),c=q();
...
return r.createElement("form",pe({ref:t,method:y,action:b,onSubmit:o?d:e=>{if(d&&d(e),e.defaultPrevented)return;e.preventDefault();let t=e.nativeEvent.submitter,r=(null==t?void 0:t.getAttribute("formmethod"))||c;g(t||e.currentTarget,{fetcherKey:n,method:r,navigate:a,replace:i,state:l,relative:p,preventScrollReset:m,unstable_viewTransition:f})}},v))})).displayName="Form",function(e){e.UseScrollRestoration="useScrollRestoration",e.UseSubmit="useSubmit",e.UseSubmitFetcher="useSubmitFetcher",e.UseFetcher="useFetcher",e.useViewTransitionState="useViewTransitionState"}(Te||(Te={})),function(e){e.UseFetcher="useFetcher",e.UseFetchers="useFetchers",e.UseScrollRestoration="useScrollRestoration"}(Ae||(Ae={}));let Ie=0,Oe=()=>"__"+String(++Ie)+"__";function Ue(){const[t,n]=e.useState(!1),[a,r]=e.useState(!1),[o,i]=e.useState(!1);return e.useEffect((()=>{t||n(!0)}),[t]),e.createElement("nav",{className:"navbar navbar-default navbar-fixed-top navbar-inverse navbar-trans navbar-trans-dark trans-helper navbar-fw",role:"navigation"},e.createElement("div",{className:"container"},e.createElement("div",{style:{width:"75%"},className:"navbar-header page-scroller"},e.createElement("button",{type:"button",onClick:e=>{console.info("hi2"),e.preventDefault(),r(!a)},className:"navbar-toggle collapsed","data-toggle":a?"collapse in":"collapse","data-target":"#navbar","aria-expanded":a?"true":"false","aria-controls":"navbar"},e.createElement("span",{className:"sr-only"},"Toggle navigation"),e.createElement("span",{className:"icon-bar"}),e.createElement("span",{className:"icon-bar"}),e.createElement("span",{className:"icon-bar"})),e.createElement("a",{className:"navbar-brand",href:"index.html"},e.createElement("img",{className:"navbar-logo-dark",style:{content:"unset",height:"50px",backgroundImage:"none"},src:"radar_big.webp",alt:"React Adobe Embed Canary Testing Endpoint"}))),e.createElement("div",{id:"navbar","aria-expanded":a?"true":"false",className:a?"navbar-collapse   collapse in":" navbar-collapse   collapse"},e.createElement("ul",{className:"nav navbar-nav"},e.createElement("li",null,e.createElement(Pe,{"data-testid":"home-link",to:"/test"},"Home",e.createElement("span",{className:"sr-only"}))),e.createElement("li",{onClick:()=>{i(!o)},className:"dropdown"+(o?" open":"")},e.createElement(Pe,{className:"dropdown-toggle","data-testid":"test-link",to:"#"},"Test",e.createElement("span",{className:"caret"})),e.createElement("ul",{className:"dropdown-menu"},e.createElement("div",{className:"row"},e.createElement("div",{className:"col-lg-6 mb-sm-30"},e.createElement("li",{className:"dropdown-header"},"Test Routes"),e.createElement("li",{className:"divider"}),e.createElement("li",null,e.createElement(Pe,{to:"/home"},"Basic PDF Render")),e.createElement("li",null,e.createElement(Pe,{to:"/light"},"Lightbox PDF Render")),e.createElement("li",null,e.createElement(Pe,{to:"/cdn"},"CDN Loaded PDF Render"))))))))))}function Be(){return e.createElement("footer",{className:"footer-widgets"},e.createElement("div",{className:"copyright"},e.createElement("div",{className:"container"},e.createElement("div",{className:"row"},e.createElement("div",{className:"col-sm-6"},e.createElement("small",null,"© 2024 by Ziping liu. Proudly Served with ",e.createElement("a",{className:"no-style-link",href:"https://github.com/ZIPING-LIU-CORPORATION/react-adobe-embed/blob/slave/.github/workflows/canaryapp.yml"},"Github Pages"))),e.createElement("div",{className:"col-sm-6"},e.createElement("small",null,e.createElement("a",{href:"#page-top",className:"pull-right to-the-top"},"To the top",e.createElement("i",{className:"fa fa-angle-up"}))))))))}function Me({divId:e,viewerConfig:t,url:n,clientID:a,_fileMeta:r,_dcView:o}){const i={clientId:a,divId:e};return(o||new window.AdobeDC.View(i)).previewFile({content:{location:{url:n}},metaData:r||We.demoMetaData},t)}
/**
...
/**
   ...
   */function je(t){const[n,a]=e.useState(!1),[r,o]=e.useState(!1),[i,l]=e.useState(!1),s=(0,e[t?.useReactHookForAdobeAPIConfigs||"useMemo"])((()=>{if(!0===n){const e=window.AdobeDC?.View;return e}}),[n]);(0,e[t?.useReactHookWhenLoadingAdobeAPI||"useEffect"])((()=>{if(!1===i){const e=document.querySelector(`script.react-adobe-embed-handholding-adobe-api-loading-idiocy[data-adobe-pdf-id="${t.id||We.staticDivId}"]`);if(e)t.debug&&console.info("[1mAdobe SDK Check[0m","Reloading and Rerendering Adobe SDK"),
// Lightbox mode renders from ui event triggered by user, so no need to render
"LIGHT_BOX"!==t.previewConfig?.embedMode&&o(!0),e.setAttribute("data-testid","react-adobe-embed-handholding-adobe-api-loading-idiocy-reused");else{t.debug&&console.info("[1mAdobe SDK Check[0m","Initial Adobe SDK Load");const e=document.createElement("script");e.setAttribute("data-testid","react-adobe-embed-handholding-adobe-api-loading-idiocy-initial"),e.setAttribute("data-adobe-pdf-id",t.id||We.staticDivId),e.setAttribute("class","react-adobe-embed-handholding-adobe-api-loading-idiocy"),e.src=t.previewConfig?.viewSdkViewerScript||We.staticDefaultConfig.viewSdkViewerScript,e.async=!0,e.onload=()=>{l(!0)},document.body.appendChild(e)}}}),[t.id,i,n]);(0,e[t?.useReactHookWhenCallingAdobeAPI||"useEffect"])((()=>{!1===n&&!0===i&&document.addEventListener("adobe_dc_view_sdk.ready",(()=>{a(!0)}));!0===i&&!0===n&&(e=>{e.debug&&console.info("Adobe PDF Viewer SDK Ready Event",s,window.adobe_dc_view_sdk);const t=e.id||We.staticDivId;document.getElementById(t)&&"LIGHT_BOX"!==e.previewConfig?.embedMode?(e.debug&&console.info("Adobe PDF Viewer SDK Ready Rendering"),Me({divId:t,viewerConfig:e.previewConfig||We.staticDefaultConfig,url:e.url||We.demoUrl,clientID:e.clientId,_fileMeta:e.fileMeta})):"LIGHT_BOX"===e.previewConfig?.embedMode&&e?.triggerAdobeDCViewRender&&Me({divId:e.id||We.staticDivId,viewerConfig:e.previewConfig||We.staticDefaultConfig,url:e.url||We.demoUrl,clientID:e.clientId})})(t)}),[n,i,t,s]);return(0,e[t?.useReactHookForComponentDidUpdate||"useEffect"])((()=>{if(!0===r){const e=t.id||We.staticDivId;document.getElementById(e)&&Me({divId:e,viewerConfig:t.previewConfig||We.staticDefaultConfig,url:t.url||We.demoUrl,clientID:t.clientId,_fileMeta:t.fileMeta}),o(!1)}}),[r,t]),e.createElement(Fe,{...t})}const We={demoUrl:"https://acrobatservices.adobe.com/view-sdk-demo/PDFs/Bodea%20Brochure.pdf",staticDefaultConfig:{showAnnotationTools:!1,showLeftHandPanel:!1,showPageControls:!1,viewSdkViewerScript:"https://acrobatservices.adobe.com/view-sdk/viewer.js",showDownloadPDF:!1,showPrintPDF:!1},staticDivId:"pdf-div",demoMetaData:{fileName:"Odd Distateful Adobe Example Pdf.pdf",id:"6d07d124 - ac85–43b3 - a867–36930f502ac6"}};function He(){switch(window.location.hostname){case"localhost":default:return"324caa2a91b84f688935436cd2d25217";case"ziping.dev":return"2aeb65914ea244cd85c16b60ca3b688d";case"ziping.life":return"2daf6038d0f1447fb9dd17988e93b5b8";case"ziping.org":return"312487a25a5b4c0d845f6d93e8103c32";case"awsuni.com":return"50d3f2b88101430f8da3006527dcdf78";case"twitterliu.com":return"ac52e99ebc8242e9bf85ecb55444f726";case"one.ziping.org":return"2e5605e61e5b4306829b619d6fad2dc4";case"zipingl.github.io":return"9c16d364507948289a9f65f9ab9da8bf";case"ziping-liu-corporation.github.io":return"875691e089ad4bf6bc4c5cea79403542"}}function Ve(){const t=window.location.href.split("?")[1],n=new URLSearchParams(t),a=n.get("pdf")||n.get("url")||"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",r=n.get("width"),o=n.get("height"),i=n.get("fileName")||a.split("/").pop()||"23andMe_Ancestry_Book.pdf";return e.createElement("section",{id:"about",className:"container section"},e.createElement("div",{className:"row ws-m"},e.createElement("header",{className:"sec-heading"},e.createElement("h2",null,"Basic Test View"),e.createElement("span",{className:"subheading"},"Using the react-adobe-embed component with no additional configurations, except for the pdf url, in order to test the rendering of a PDF at the most basic level of usage.")),e.createElement(je,{previewConfig:{},className:"col container-fluid post-content",fileMeta:{fileName:i},style:{width:r||"100%",height:o||"calc(100vh - 200px)",maxHeight:"100%",border:"1px solid transparent",alignContent:"center",justifyContent:"center",minHeight:"500px"},url:a||"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",debug:!0,id:"adobe-dc-view-0",clientId:He()})))}function $e(){return e.createElement("section",{className:"container section"},e.createElement("div",{className:"row ws-m"},e.createElement("div",{className:"col s12",style:{height:"calc(100vh - 420px)"}},e.createElement(je,{url:"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",clientId:He(),previewConfig:{embedMode:"LIGHT_BOX"},debug:!0}),e.createElement("button",{className:"btn btn-primary",onClick:()=>{Me({url:"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",viewerConfig:{embedMode:"LIGHT_BOX"},clientID:He(),divId:"pdf-div",_fileMeta:{fileName:"23andMe_Ancestry_Book.pdf"}})}},"Toggle Light Box View"))))}function ze(){const[t,n]=e.useState(!1),[a,r]=e.useState(!1);e.useEffect((()=>{if(!t){
