...
params:a,pathname:I([r,c.pathname]),pathnameBase:_(I([r,c.pathnameBase])),route:u}),"/"!==c.pathnameBase&&(r=I([r,c.pathnameBase]))}return o}
/**
...
/**
   * @private
   */(s||"",a),e}),{}),pathname:o,pathnameBase:i,pattern:e}}function L(e){try{return decodeURI(e)}catch(t){return c(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent encoding ('+t+")."),e}}function k(e,t){if("/"===t)return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;
...
/**
   * @private
   */function A(e,t,n,a){let r;void 0===a&&(a=!1),"string"==typeof e?r=p(e):(r=o({},e),s(!r.pathname||!r.pathname.includes("?"),T("?","pathname","search",r)),s(!r.pathname||!r.pathname.includes("#"),T("#","pathname","hash",r)),s(!r.search||!r.search.includes("#"),T("#","search","hash",r)));let i,l=""===e||""===r.pathname,c=l?"/":r.pathname;
...
if(null==c)i=n;else if(a){let e=t[t.length-1].replace(/^\//,"").split("/");if(c.startsWith("..")){let t=c.split("/");
// With relative="path", each leading .. segment means "go up one URL segment"
for(;".."===t[0];)t.shift(),e.pop();r.pathname=t.join("/")}i="/"+e.join("/")}else{let e=t.length-1;if(c.startsWith("..")){let t=c.split("/");
...
n.length>1&&n.pop():"."!==e&&n.push(e)})),n.length>1?n.join("/"):"/"}(n,t):t;return{pathname:o,search:U(a),hash:O(r)}}(r,i),d=c&&"/"!==c&&c.endsWith("/"),h=(l||"."===c)&&n.endsWith("/");
...
if(void 0===r&&(r={}),c(l.current,G),!l.current)return;if("number"==typeof a)return void n.go(a);let s=A(a,JSON.parse(i),o,"path"===r.relative);
...
/**
   ...
   */()}function X(e,t){let{relative:n}=void 0===t?{}:t,{matches:a}=r.useContext($),{pathname:o}=q(),i=JSON.stringify(P(a).map((e=>e.pathnameBase)));return r.useMemo((()=>A(e,JSON.parse(i),o,"path"===n)),[e,i,o,n])}
/**
...
// router loaded. We can help them understand how to avoid that.
"useRoutes() may be used only in the context of a <Router> component.");let{navigator:o}=r.useContext(H),{matches:i}=r.useContext($),l=i[i.length-1],u=l?l.params:{},d=l?l.pathname:"/",h=l?l.pathnameBase:"/",m=l&&l.route;{
...
let i=e.getAttribute("action");a=i?k(i,t):null,n=e.getAttribute("method")||me,r=ye(e.getAttribute("enctype"))||fe,o=new FormData(e)}else if(function(e){return ve(e)&&"button"===e.tagName.toLowerCase()}(e)||function(e){return ve(e)&&"input"===e.tagName.toLowerCase()}(e)&&("submit"===e.type||"image"===e.type)){let i=e.form;if(null==i)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');
...
if(a=l?k(l,t):null,n=e.getAttribute("formmethod")||i.getAttribute("method")||me,r=ye(e.getAttribute("formenctype"))||ye(i.getAttribute("enctype"))||fe,
...
return null!=D(o.pathname,l)||null!=D(o.pathname,i)}(p)&&!0===u,b=v.encodeLocation?v.encodeLocation(p).pathname:p.pathname,y=m.pathname,w=f&&f.navigation&&f.navigation.location?f.navigation.location.pathname:null;a||(y=y.toLowerCase(),w=w?w.toLowerCase():null,b=b.toLowerCase());
// If the `to` has a trailing slash, look at that exact spot.  Otherwise,
// we're looking for a slash _after_ what's in `to`.  For example:

// <NavLink to="/users"> and <NavLink to="/users/">
// both want to look for a / at index 6 to match URL `/users/matt`
const E="/"!==b&&b.endsWith("/")?b.length-1:b.length;let R,C=y===b||!i&&y.startsWith(b)&&"/"===y.charAt(E),N=null!=w&&(w===b||!i&&w.startsWith(b)&&"/"===w.charAt(b.length)),x={isActive:C,isPending:N,isTransitioning:g},S=C?n:void 0;R="function"==typeof o?o(x):[o,C?"active":null,N?"pending":null,g?"transitioning":null].filter(Boolean).join(" ");let L="function"==typeof l?l(x):l;
return r.createElement(ke,he({},h,{"aria-current":S,className:R,ref:t,style:L,to:c,unstable_viewTransition:u}),"function"==typeof d?d(x):d)})).displayName="NavLink";
//#endregion
////////////////////////////////////////////////////////////////////////////////
//#region Hooks
////////////////////////////////////////////////////////////////////////////////
var Te,Pe;function Ae(e){let t=r.useContext(j);return t||s(!1,
// Internal hooks
function(e){return e+" must be used within a data router.  See https://reactrouter.com/routers/picking-a-router."}(e)),t}r.forwardRef(((e,t)=>{let{fetcherKey:n,navigate:a,reloadDocument:o,replace:i,state:l,method:c=me,action:u,onSubmit:d,relative:p,preventScrollReset:m,unstable_viewTransition:f}=e,v=pe(e,Ce),g=
/**
   * Returns a function that may be used to programmatically submit a form (or
   * some arbitrary data) to the server.
   */
function(){let{router:e}=Ae(Te.UseSubmit),{basename:t}=r.useContext(H),n=ie(re.UseRouteId);return r.useCallback((function(a,r){void 0===r&&(r={}),function(){if("undefined"==typeof document)throw new Error("You are calling submit during the server render. Try calling submit within a `useEffect` or callback instead.")}();let{action:o,method:i,encType:l,formData:s,body:c}=we(a,t);if(!1===r.navigate){let t=r.fetcherKey||_e();e.fetch(t,n,r.action||o,{preventScrollReset:r.preventScrollReset,formData:s,body:c,formMethod:r.method||i,formEncType:r.encType||l,unstable_flushSync:r.unstable_flushSync})}else e.navigate(r.action||o,{preventScrollReset:r.preventScrollReset,formData:s,body:c,formMethod:r.method||i,formEncType:r.encType||l,replace:r.replace,state:r.state,fromRouteId:n,unstable_flushSync:r.unstable_flushSync,unstable_viewTransition:r.unstable_viewTransition})}),[e,t,n])}
// v7: Eventually we should deprecate this entirely in favor of using the
// router method directly?
(),b=function(e,t){let{relative:n}=void 0===t?{}:t,{basename:a}=r.useContext(H),o=r.useContext($);o||s(!1,"useFormAction must be used inside a RouteContext");let[i]=o.matches.slice(-1),l=he({},X(e||".",{relative:n})),c=q();
...
const o=window.ReactViewAdobe;return e.createElement("section",{className:"container section"},e.createElement("div",{className:"row ws-m"},e.createElement("div",{className:"col s12"},e.createElement("header",{className:"sec-heading"},e.createElement("h2",null,"CDN Loaded Basic PDF Render"),e.createElement("span",{className:"subheading"},"Content Delivery Networking (CDN) allows the delivery of the react-adobe-embed component to a browser environment to occur as ",e.createElement("strong",null,"a separate process")," from the main body of the web application's code.")),e.createElement("p",null,"This approach involves loading the component as an independent script within the initial HTML page load, effectively integrating it into the HTML DOM environment. This method not only reduces the space required by the web application, thereby enhancing its load speed, but also leverages the benefits of distributed loading. By loading distinct components of the web application through separate network requests, we can maximize efficiency. In this instance, the react-adobe-embed component is sourced from a CDN as a separate network request, distinct from the main web application. This effectively allows the web application to load in two concurrent parts, or at least simulates this effect, thanks to the inherent multi-threading capabilities of computer systems."),a&&t&&o&&e.createElement(o,{clientId:We(),url:"https://raw.githubusercontent.com/ZipingL/dna/main/23andMe_Ancestry_Book.pdf",debug:!0,className:"col container-fluid post-content",style:{height:"calc(100vh - 420px)",width:"100%"},previewConfig:{},fileMeta:{fileName:"23andMe_Ancestry_Book.pdf"}}))))}const ze=document.getElementById("app");ze&&t.createRoot(ze).render(e.createElement((function(){return e.createElement(Se,null,e.createElement(Ue,null),e.createElement(ue,null,e.createElement(se,{path:"/test",element:e.createElement("div",{className:"section container"},e.createElement("div",{className:"row"},e.createElement("div",{className:"col s12"},e.createElement("h5",{"data-testid":"test-route",className:"header"},"Test Route View"),e.createElement("iframe",{src:"https://one.ziping.org/ZIPING-LIU-CORPORATION/react-adobe-embed/blob/slave/README.md/?domain=github.com",style:{width:"100%",height:"900px",border:"1px solid transparent",alignContent:"center",justifyContent:"center"}}))))}),e.createElement(se,{path:"/home",element:e.createElement(He,null)}),e.createElement(se,{path:"/light",element:e.createElement(Ve,null)}),e.createElement(se,{path:"/cdn",element:e.createElement($e,null)})),e.createElement(Oe,null))}),null))}));
