...
/**
   * @private
   */function P(e,t,n,a){let r;void 0===a&&(a=!1),"string"==typeof e?r=p(e):(r=o({},e),s(!r.pathname||!r.pathname.includes("?"),T("?","pathname","search",r)),s(!r.pathname||!r.pathname.includes("#"),T("#","pathname","hash",r)),s(!r.search||!r.search.includes("#"),T("#","search","hash",r)));let i,l=""===e||""===r.pathname,c=l?"/":r.pathname;
...
// router loaded. We can help them understand how to avoid that.
"useNavigate() may be used only in the context of a <Router> component.");let e=r.useContext(j),{basename:t,navigator:n}=r.useContext(H),{matches:a}=r.useContext($),{pathname:o}=q(),i=JSON.stringify(A(a).map((e=>e.pathnameBase))),l=r.useRef(!1);return Z((()=>{l.current=!0})),r.useCallback((function(a,r){
// Short circuit here since if this happens on first render the navigate
...
/**
   ...
   */()}function X(e,t){let{relative:n}=void 0===t?{}:t,{matches:a}=r.useContext($),{pathname:o}=q(),i=JSON.stringify(A(a).map((e=>e.pathnameBase)));return r.useMemo((()=>P(e,JSON.parse(i),o,"path"===n)),[e,i,o,n])}
/**
...
//#region Hooks
////////////////////////////////////////////////////////////////////////////////
var Te,Ae;function Pe(e){let t=r.useContext(j);return t||s(!1,
// Internal hooks
