...
function A(e,t){let n=function(e){return e.filter(((e,t)=>0===t||e.route.path&&e.route.path.length>0))}(e);
...
// router loaded. We can help them understand how to avoid that.
"useNavigate() may be used only in the context of a <Router> component.");let e=r.useContext(j),{basename:t,future:n,navigator:a}=r.useContext(H),{matches:o}=r.useContext($),{pathname:i}=q(),l=JSON.stringify(A(o,n.v7_relativeSplatPath)),u=r.useRef(!1);return Z((()=>{u.current=!0})),r.useCallback((function(n,r){
// Short circuit here since if this happens on first render the navigate
...
/**
   ...
   */()}function X(e,t){let{relative:n}=void 0===t?{}:t,{future:a}=r.useContext(H),{matches:o}=r.useContext($),{pathname:i}=q(),l=JSON.stringify(A(o,a.v7_relativeSplatPath));return r.useMemo((()=>T(e,JSON.parse(l),i,"path"===n)),[e,l,i,n])}
/**
...
//#region Hooks
////////////////////////////////////////////////////////////////////////////////
var Ae,Te;function _e(e){let t=r.useContext(j);return t||s(!1,
// Internal hooks
